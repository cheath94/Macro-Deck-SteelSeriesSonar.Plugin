...
public class StreamerChannelConfigControl : ActionConfigControl
{
    ...
    public StreamerChannelConfigControl(
        PluginAction action,
    ...
    public override bool OnActionSave()
    {
        ...
        SonarChannel channel =
            channelBox.SelectedItem
                is ChannelOption selectedChannel
        ...
        SonarChannel channel)
    {
             ...
             index++)
        {
            ...
            {
                channelBox.SelectedIndex = index;
                return;
            }
        }
    }
